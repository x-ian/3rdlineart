                ...
                if (notfound) {                    
                    ...
                    $.ajax({                                      
                      url: 'getsubcat.php',
                            ...
                            success: function(data)
                        {
                            $('#art_district_refer').empty().html(data);/complete_form.php&pat_id=5
                        }                        
                        });
...
// clinic status info
  ...
  <table style="width:100%" border="0">
    ...
    <tr>
     ...
     <td>              
      <input type="text" class="span4 smalltb" id="art_id_num_facility" value="<?php echo $art_id_facility; ?>" name="art_id_num_facility" required>
      -
      <input type="text" class="span4 smalltb" id="art_id_num" value="<?php echo explode("-", $art_id_num)[1]; ?>" name="art_id_num" required>
    </td>    
    <td>
      <h4>Gender</h4>
    </td>    
