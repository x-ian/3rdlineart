<form id="edit-profile" class="form-horizontal" action="app.php" method="post">
	...
	<table class="table table-striped table-bordered">
		...
		<tbody>
			<?php
            $patient = mysqli_query( $bd, "SELECT * FROM patient, form_creation WHERE patient.id = form_creation.patient_id");
            while ($row_patient=mysqli_fetch_array($patient)){
				...
				<tr>
					...
					<!-- <td class="td-actions"><a href="../app.php?part_1&pat_id='.$id.'"> Edit </i></a></td> -->
